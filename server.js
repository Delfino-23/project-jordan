...
const startServer = async () => {
  try {
    ...
    // 2. SINCRONIZA: Cria as tabelas (como Pergunta) no DB se elas não existirem
    await sequelize.sync({ force: false }); // **CRUCIAL: force: false** para não apagar dados existentes
